...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (defun on-after-init ()
    (unless (display-graphic-p (selected-frame))
      ...
      (set-face-attribute 'default nil :foreground "black" :weight 'normal)))
